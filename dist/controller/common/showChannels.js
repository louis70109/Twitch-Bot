...
var streamCarousel_1 = __importDefault(require("../../template/common/line/streamCarousel"));
var follow_1 = __importDefault(require("../../template/messenger/users/follow"));
function showChannels(context, streams, platform) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, output, index, ch;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [3 /*break*/, 5];
                case 3:
                    streamCarousel_1.default(context, streams);
                    return [3 /*break*/, 7];
                case 4:
