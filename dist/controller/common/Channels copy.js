...
var streams_1 = __importDefault(require("../../common/line/streams"));
var streams_2 = __importDefault(require("../../common/messenger/streams"));
function showChannels(context, platform, streams) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, output, streamLength, index, ch;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    output = '';
                    streamLength = streams.length ? streams.length < 12 : 12;
                    for (index = 0; index < streamLength; index++) {
