...
function userBinding(context, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var userName, lineId, twitchClient, twitchUser, userObj, user, isAlive;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    userName = (_b = match.groups) === null || _b === void 0 ? void 0 : _b.name;
                    lineId = (_d = (_c = context._session) === null || _c === void 0 ? void 0 : _c.user) === null || _d === void 0 ? void 0 : _d.id;
                ...
                case 2:
                    ...
                    user = new user_1.UserModel(userObj);
                    return [4 /*yield*/, user_1.UserModel.findOne({ lineId: lineId })];
                case 3:
                    isAlive = _e.sent();
                ...
                case 5:
                    ...
                    return [4 /*yield*/, user_1.UserModel.updateOne({ lineId: lineId }, userObj)];
                case 6:
                    _e.sent();
                    _e.label = 7;
                case 7: return [4 /*yield*/, context.sendText('綁定完成')];
                case 8:
                    _e.sent();
                    return [2 /*return*/];
            }
